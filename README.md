...
curl -fsSL https://raw.githubusercontent.com/Swastik023/multi-touch-marketing-attribution/main/scripts/provision.sh | bash

# 2. Get the code and configure it
git clone https://github.com/Swastik023/multi-touch-marketing-attribution /opt/insight && cd /opt/insight
cp .env.example .env
